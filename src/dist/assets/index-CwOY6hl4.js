...
function gr(e, n, t, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), Do(e)))
    ...
    for (e = s.call(e), i = 0; !(u = e.next()).done; )
      (u = u.value), (s = r + gl(u, i++)), (o += gr(u, n, t, s, l));
  else if (u === "object")
    throw (
      ((n = String(e)),
      Error(
...
var Xe = yc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Lc(e, n, t, r, l, u, o, i, s) {
  (Et = !1), (Rr = null), Nc.apply(zc, arguments);
}
function Tc(e, n, t, r, l, u, o, i, s) {
  if ((Lc.apply(this, arguments), Et)) {
    if (Et) {
      var c = Rr;
      (Et = !1), (Rr = null);
...
var Te = Math.clz32 ? Math.clz32 : $c,
  jc = Math.log,
  Uc = Math.LN2;
function $c(e) {
...
function Ju(e, n, t, r) {
  if (Ir) {
    var l = au(e, n, t, r);
    if (l === null) Ml(e, n, r, Fr, t), Ko(e, r);
    else if (Wc(l, e, n, t, r)) r.stopPropagation();
    else if ((Ko(e, r), n & 4 && -1 < Hc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Zt(l);
        if (
          (u !== null && Ps(u),
...
var Fr = null;
function au(e, n, t, r) {
  if (((Fr = null), (e = Yu(r)), (e = Sn(e)), e !== null))
...
var ut = {
  ...
  Go = ge(nl),
  Gc = V({}, nl, { dataTransfer: 0 }),
  Zc = ge(Gc),
  Jc = V({}, Gt, { relatedTarget: 0 }),
  Pl = ge(Jc),
  qc = V({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  bc = ge(qc),
  ef = V({}, ut, {
...
var sf = V({}, Gt, {
  ...
  df = ge(ff),
  pf = V({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  mf = ge(pf),
  vf = V({}, nl, {
    deltaX: function (e) {
...
var gf = We && "TextEvent" in window && !Ct,
  Ms = We && (!no || (Ct && 8 < Ct && 11 >= Ct)),
  qo = " ",
  bo = !1;
function Ds(e, n) {
  switch (e) {
...
function Us(e) {
  if (e.propertyName === "value" && tl(Ft)) {
    var n = [];
    Fs(n, Ft, e, Yu(e)), ys(Ef, n);
  }
}
function _f(e, n, t) {
  e === "focusin"
    ? (ti(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", Us))
    : e === "focusout" && ti();
}
function xf(e) {
...
for (var Tl = 0; Tl < oi.length; Tl++) {
  var Rl = oi[Tl],
    Rf = Rl.toLowerCase(),
    Of = Rl[0].toUpperCase() + Rl.slice(1);
  pn(Rf, "on" + Of);
}
  ...
  if (!e[ar]) {
    (e[ar] = !0),
      ns.forEach(function (t) {
        t !== "selectionchange" && (Mf.has(t) || Ol(t, !1, e), Ol(t, !0, e));
      });
...
var ot = Math.random().toString(36).slice(2),
  ...
  hu = "__reactEvents$" + ot,
  $f = "__reactListeners$" + ot,
  Vf = "__reactHandles$" + ot;
function Sn(e) {
  var n = e[Fe];
  if (n) return n;
...
function vn() {
  if (!Il && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), ks(Xu, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function ho(e, n, t, r, l, u) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (_r.current = e === null || e.memoizedState === null ? Yf : Xf),
    (e = t(r, l)),
    Pt)
  ) {
    u = 0;
  ...
  Yf = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        ...
        xr(4194308, 4, va.bind(null, n, e), t)
      );
    },
...
function zi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Pr(e, n), _a(n, t, r), Eu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function qf(e, n, t, r, l, u, o) {
  ...
  if (((i = (o & e.childLanes) !== 0), ae || i)) {
    ...
    return Po(), (r = Vl(Error(y(421)))), pr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function rd(e, n) {
  ...
  for (pu = { focusedElem: e, selectionRange: t }, Ir = !1, k = n; k !== null; )
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[hu], delete n[$f], delete n[Vf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Qo(t), n === 1))
      e.tag === 0 ? Af(ji.bind(null, e)) : Zs(ji.bind(null, e)),
        jf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
vs = _o;
hs = Ln;
var wd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ps, ms, _o] },
  ht = {
...
var kd = qi.exports,
  Ai = kd;
(Wl.createRoot = Ai.createRoot), (Wl.hydrateRoot = Ai.hydrateRoot);
const yr = (e) =>
    Ie.createElement("div", { className: "card" }, [
      Ie.createElement("img", { src: e.src }, null),
    ]),
  Ed = () => (
    Ie.createElement("div"),
    [
      Ie.createElement("h1", {}, "Tarot Reading"),
      Ie.createElement("div", { className: "reading-table" }, [
        Ie.createElement(yr, { src: "/cards/512px-CardBack.jpg" }, null),
        Ie.createElement(yr, { src: "/cards/512px-Swords07.jpg" }, null),
        Ie.createElement(yr, { src: "/cards/512px-Swords08.jpg" }, null),
        Ie.createElement(
          yr,
          { src: "/cards/512px-RWS_Tarot_21_World.jpg" },
          null,
        ),
      ]),
    ]
  ),
  Cd = document.getElementById("root"),
  _d = Wl.createRoot(Cd);
_d.render(Ie.createElement(Ed));
